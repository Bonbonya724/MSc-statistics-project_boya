...
maic <- function(A.X, B.summary) {
  ...
  out.optim <- optim(fn = objective.function, X = A.X, par = beta.start, method = "Nelder-Mead")
  # betas
...
#
# present the results: are there certain scenarios that marg vs. cond is smal
# (selection: correlation influence the diff)
