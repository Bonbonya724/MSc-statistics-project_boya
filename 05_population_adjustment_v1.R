...
# load(file = "survival_settings_condff.RData") # two different settings, make sure loaded
load(file = "survival_settings_margff.RData") # two different settings, make sure loaded
# source('functions.R') # load MAIC functions 
                      # orginial code use BFGS method in optim()
source('02_Functions.R') # use Nelder-Mead method in optim()
